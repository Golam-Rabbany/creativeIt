        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="contact-form">
              <?php
                  if(isset($_SESSION['guest_msg_done'])): ?>
                <small class="text-success"><?=$_SESSION['guest_msg_done']?></small>
                <?php unset($_SESSION['guest_msg_done'])  ?>
                <?php endif  ?> 
              <form id="contact" action="another/guest_message/guest_msg_post.php" method="post">
                <div class="row">
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <small class="text-danger"><?=$_SESSION['guest_name_error']?></small>
                    <?php unset($_SESSION['guest_name_error'])  ?>
                    <?php endif ?> 
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                    ...
                    <small class="text-danger"><?=$_SESSION['guest_email_error']?></small>
                    <?php unset($_SESSION['guest_email_error'])  ?>
                    <?php endif  ?> 
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                    ...
                    <?php
                      if(isset($_SESSION['guest_subject_error'])): ?>
                    <small class="text-danger"><?=$_SESSION['guest_subject_error']?></small>
                    <?php unset($_SESSION['guest_subject_error'])  ?>
                    <?php endif  ?> 
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                    ...
                    <small class="text-danger"><?=$_SESSION['guest_message_error']?></small>
                    <?php unset($_SESSION['guest_message_error'])  ?>
                    <?php endif  ?> 
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
